// Generated by CoffeeScript 1.3.3, then altered by Chris Hughes, who doesn't understand CoffeeScript
(function() {
  ...
  updateStops = function(json) {
    ...
    for (_i = 0, _len = json.length; _i < _len; _i++) {
      ...
      m.on('click', function(e) {
		this.bindPopup("<h2><a target='_new' href='http://abqwtb.com/m/stop.php?stop="+this.stop_id+"'>"+this.stop_id+"</a></h2>").openPopup();
      });
      map.addLayer(m);
